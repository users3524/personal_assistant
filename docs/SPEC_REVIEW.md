...
当前取舍：深夜引擎已实现前台 Catch-Up Guard、Android WorkManager 注册、任务冷表、结构化 runner 和真实素材组包；WorkManager 回调当前只做安全空执行，raw pack 裁剪、AI 生成和日报写入仍按 TODO 分步接入。桌面/Web 不追求后台常驻。
